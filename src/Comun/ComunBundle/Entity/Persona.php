 ...
 * @ORM\DiscriminatorMap({"Medico" = "Cipen\MedicoBundle\Entity\Medico", "Paciente" = "Cipen\PacienteBundle\Entity\Paciente", "Responsable" = "Cipen\PacienteBundle\Entity\Responsable"})
 */
class Persona
{
    /**
