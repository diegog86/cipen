 ...
 * @ORM\DiscriminatorMap({"Personal" = "Cipen\PersonalBundle\Entity\Personal", "Paciente" = "Cipen\PacienteBundle\Entity\Paciente", "Responsable" = "Cipen\PacienteBundle\Entity\Responsables"})
 */
class Persona
{
    /**
